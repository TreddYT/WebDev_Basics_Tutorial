// ---------- EPISODE 4 - VARIABLES & DATA TYPES ----------
// Declaring variables
...
// ---------- EPISODE 5 - IFS, SWITCHES, & LOGICAL OPERATORS ----------
...
// ---------- EPISODE 7 - STRING & ARRAY METHODS ----------
...
// includes
console.log(greeting.includes("Hey")); // true
console.log(greeting.includes("Hello")); // false

//startsWith & endsWith
console.log(greeting.startsWith("H")); // true
console.log(greeting.endsWith("folks")); // false

// substring
console.log(greeting.substring(4, 9)); // "there"

// split
console.log(greeting.split(" ")); // ["Hey", "there,", "folks!"]
console.log(greeting.split(", ")); // ["Hey there", "folks!"]
...
console.log(colors); // ["brown", "red", "green"]
...
colors.splice(1, 1, "yellow", "purple"); // add AND remove data
console.log(colors); // ["red", "yellow", "purple", "blue"]

colors = ["red", "green", "blue"];
colors.splice(1, 0, "yellow", "purple");  // just add data
console.log(colors); // ["red", "yellow", "purple", "green", "blue"]

colors = ["red", "green", "blue"];
colors.splice(1, 2);  // just remove data
console.log(colors); // ["red"]

// slice
colors = ["red", "green", "blue"];
const subArray = colors.slice(0, 2);
console.log(colors); // ["red", "green", "blue"]
console.log(subArray); // ["red", "green"]
